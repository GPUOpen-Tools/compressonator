...
copyright = u'2017 to 2019, AMD Developer Tools'
...
version = u'Compressonator - latest build'
# The full version, including alpha/beta/rc tags.
release = u'Compressonator - latest build'
...
htmlhelp_basename = 'Compressonatordoc'
...
latex_documents = [
    (master_doc, 'Compressonator.tex', u'Compressonator Documentation',
...
man_pages = [
    (master_doc, 'Compressonator', u'Compressonator Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Compressonator', u'Compressonator Documentation',
     author, 'Compressonator', 'One line description of project.',
     'Miscellaneous'),
]
