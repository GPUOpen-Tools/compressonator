...
class IndexTypeVector {
  public:
    ...
    void resize(size_t size, const ValueTypeT &val) {
        vector_.resize(size, val);
    }
    void assign(size_t size, const ValueTypeT &val) {
        vector_.assign(size, val);
    }
    ...
    void push_back(const ValueTypeT &val) {
        vector_.push_back(val);
    }
    void push_back(ValueTypeT &&val) {
