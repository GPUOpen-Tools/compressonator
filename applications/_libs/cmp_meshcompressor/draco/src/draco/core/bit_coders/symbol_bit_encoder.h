#ifndef DRACO_CORE_BIT_CODERS_SYMBOL_BIT_ENCODER_H_
#define DRACO_CORE_BIT_CODERS_SYMBOL_BIT_ENCODER_H_
...
class SymbolBitEncoder {
  public:
    ...
    void EncodeBit(bool bit) {
        EncodeLeastSignificantBits32(1, bit ? 1 : 0);
    }
...
#endif  // DRACO_CORE_BIT_CODERS_SYMBOL_BIT_ENCODER_H_
