...
class PlyProperty {
  public:
    ...
    bool is_list() const {
        return list_data_type_ != DT_INVALID;
    }
    DataType data_type() const {
        return data_type_;
    }
    int data_type_num_bytes() const {
        return data_type_num_bytes_;
    }
    DataType list_data_type() const {
        return list_data_type_;
    }
    int list_data_type_num_bytes() const {
        return list_data_type_num_bytes_;
    }
