...
%ADVANCED_INSTALLER% /edit AMDCompressCore_64.aip /SetVersion 4.1.%BUILD_NUMBER%
%ADVANCED_INSTALLER% /edit AMDCompressCore_64.aip /SetProperty  SETUP_FILE_NAME=CompressonatorCore_x64_4.1.%BUILD_NUMBER%
...
%ADVANCED_INSTALLER% /edit AMDCompressFrameWork_64.aip /SetVersion 4.1.%BUILD_NUMBER%
%ADVANCED_INSTALLER% /edit AMDCompressFrameWork_64.aip /SetProperty  SETUP_FILE_NAME=CompressonatorFrameWork_x64_4.1.%BUILD_NUMBER%
...
%ADVANCED_INSTALLER% /edit AMDCompressSDK_64.aip /SetVersion 4.1.%BUILD_NUMBER%
%ADVANCED_INSTALLER% /edit AMDCompressSDK_64.aip /SetProperty  SETUP_FILE_NAME=CompressonatorSDK_x64_4.1.%BUILD_NUMBER%
...
%ADVANCED_INSTALLER% /edit AMDCompressCLI_64.aip /SetVersion 4.1.%BUILD_NUMBER% 
%ADVANCED_INSTALLER% /edit AMDCompressCLI_64.aip /SetProperty  SETUP_FILE_NAME=CompressonatorCLI_x64_4.1.%BUILD_NUMBER%
...
%ADVANCED_INSTALLER% /edit AMDCompressGUI_64.aip /SetVersion 4.1.%BUILD_NUMBER% 
%ADVANCED_INSTALLER% /edit AMDCompressGUI_64.aip /SetProperty  SETUP_FILE_NAME=CompressonatorGUI_x64_4.1.%BUILD_NUMBER%
