...
DWORD GetChannelSize(ChannelFormat channelFormat)
{
	...
	{
		case CF_8bit:		return 1;
		case CF_Float16:	return 2;
		case CF_Float32:	return 3;
		case CF_16bit:		return 2;
		case CF_2101010:	return 1;
		case CF_32bit:		return 4;
...
DWORD GetPixelSize(const MipSet& mipset)
{
	switch(mipset.m_ChannelFormat)
	{
		...
		case CF_2101010:	return 4;
		case CF_Float16:	// Fall-through
		case CF_Float32:	// Fall-through
		case CF_16bit:		// Fall-through
		case CF_32bit:		return (GetChannelSize(mipset.m_ChannelFormat) * GetChannelCount(mipset.m_TextureDataType));
		default:			ASSERT(0); return 0;
	}
}
